...
namespace HP
{
    ...
    public static class LobbyAttributeExtenstion
    {
        ...
        public static bool GetLobbyType(this Dictionary<string, Epic.OnlineServices.Lobby.Attribute> attribute, out string type)
        {
            type = null;
            if (attribute.TryGetValue("LOBBYTYPE", out Epic.OnlineServices.Lobby.Attribute attr))
            {
        ...
        public static bool GetLobbySecurity(this Dictionary<string, Epic.OnlineServices.Lobby.Attribute> attribute, out LobbyManager.LobbySecurityType type)
        {
