...
namespace HP
{
    public class CutomTMPInputField : Selectable,
            ...
            IScrollHandler
    {
        ...
        protected void UpdateLabel()
        {
            if (m_TextComponent != null && m_TextComponent.font != null && m_PreventCallback == false)
            {
                ...
                //**Custom (add isfocused)
                if (isFocused && compositionLength > 0 && m_ReadOnly == false)
                {
        ...
        public void DeactivateInputField(bool clearSelection = false)
        {
            ...
            if (m_TextComponent != null && IsInteractable())
            {
                ...
                if (inputSystem != null)
                {
                    ...
                    text += inputSystem.compositionString;
                }
        ...
        void BindKey()
        {
            ...
            _toggleInputBinding = new ToggleInputBinding(_inputManager, _consoleActionMap, UnityEngine.InputSystem.Key.Enter);
            _consoleActionMap.Enable();
            _inputManager.Assign();
            _toggleInputBinding._onToggleInputChanged += EnterPressed;
        }
